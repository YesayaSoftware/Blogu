                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                ...
                                <p class="mt-2 text-sm text-gray-700">
                                    A detail information about {{ $category->name }} and associated posts.
                                </p>
                            </div>
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                ...
                                <span class="ml-24">&nbsp;</span>

                                <a href="{{ route('categories.edit', $category->id) }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto">
                                    Edit category
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-gray-500">Posts associated to this Category</dt>
